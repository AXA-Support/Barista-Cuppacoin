              ...
              <>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6 pt-4">
                  {currentQuizzes.map((quiz, index) => (
                    ...
                    >
                      {/* Decorative background elements */}
                      <div className="absolute top-0 right-0 w-20 md:w-24 lg:w-32 h-20 md:h-24 lg:h-32 bg-[#5b59bb]/70 rounded-full -mr-10 md:-mr-12 lg:-mr-16 -mt-10 md:-mt-12 lg:-mt-16 group-hover:scale-150 transition-transform duration-500"></div>
                      <div className="absolute bottom-0 left-0 w-16 md:w-20 lg:w-24 h-16 md:h-20 lg:h-24 bg-[#5b59bb]/30 rounded-full -ml-8 md:-ml-10 lg:-ml-12 -mb-8 md:-mb-10 lg:-mb-12 group-hover:scale-150 transition-transform duration-500"></div>

                      {/* Content */}
                      <div className="relative z-10">
                        
<div className='flex flex-row gap-2 md:gap-3 items-center mb-3 md:mb-4'>
  <svg className="w-4 md:w-5 h-4 md:h-5 text-[#5958bb] flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
    <path fillRule="evenodd" d="M5 9V7a5 5 0 0110 0v2a2 2 0 012 2v5a2 2 0 01-2 2H5a2 2 0 01-2-2v-5a2 2 0 012-2zm8-2v2H7V7a3 3 0 016 0z" clipRule="evenodd" />
  </svg>
  <h3 className="text-sm md:text-base lg:text-lg text-[#5958bb] font-medium group-hover:text-[#5b59bb] transition-colors duration-300 line-clamp-2 break-words">
    {quiz.title}
  </h3>
</div>
...
<button
  onClick={() => handleStartQuiz(quiz)}
  className="w-full sm:w-full md:w-[80%] lg:w-[70%] xl:w-[60%] mx-auto mt-4 md:mt-6 lg:mt-8 bg-gradient-to-r from-[#5b59bb] to-[#7b79db] text-white font-medium py-2 md:py-2.5 rounded-lg hover:shadow-lg hover:shadow-[#5b59bb]/30 transition-all duration-300 flex items-center justify-center gap-1.5 md:gap-2 group-hover:gap-3 active:scale-95 text-xs sm:text-sm md:text-base"
>
  <Play className="w-3.5 md:w-4 h-3.5 md:h-4 flex-shrink-0" />
  <span className="whitespace-nowrap text-xs sm:text-sm md:text-base">Start Quiz</span>
</button>
                      </div>
                    </div>
                  ))}
              ...
              <>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6 pt-4">
                  {pastQuizzes.map((quiz, index) => (
                    <div
  key={quiz.id}
  className="group relative bg-white rounded-2xl shadow-md hover:shadow-xl transition-all duration-500 hover:-translate-y-1 border-2 border-gray-300 p-4 sm:p-5 md:p-5 lg:p-6 overflow-hidden"
  style={{
    animation: `cardSlideUp 0.5s ease-out ${(index + 3) * 0.1}s both`
  }}
>
  ...
  <div className="relative z-10">
    ...
    <div className="flex flex-col gap-2.5 mb-3 md:mb-4">
      {/* First Row: Completed Badge */}
      <div className="flex items-center gap-1.5 md:gap-2 bg-green-100 rounded-lg px-2 md:px-3 py-1 md:py-1.5 border-2 border-green-700/50 w-fit">
        <CheckCircle className="w-3 md:w-4 h-3 md:h-4 text-green-700 font-medium flex-shrink-0" />
        <span className="text-xs md:text-sm font-medium text-green-700 whitespace-nowrap">Completed</span>
      </div>

      {/* Second Row: Score Section */}
      <div className="flex flex-row items-center gap-2 md:gap-2.5">
        <span className='font-medium text-[#5b59bb] text-xs md:text-sm lg:text-base whitespace-nowrap'>Scored:</span>
        <div className="relative w-10 h-10 md:w-11 md:h-11 lg:w-12 lg:h-12 rounded-full bg-white border-2 border-[#5b59bb]/70 flex items-center justify-center shadow-md flex-shrink-0">
          <span className="text-[#5b59bb] font-semibold text-xs md:text-sm lg:text-sm">
            {parseFloat(quiz.score).toFixed(0)}%
          </span>
        </div>
      </div>
    ...
    {/* Title */}
    <h3 className="text-sm md:text-base lg:text-lg text-[#5b59bb] font-medium mb-2 md:mb-2.5 transition-colors duration-300 line-clamp-2 break-words">
      {quiz.title}
    </h3>

    {/* Date */}
    <p className="text-gray-600 text-xs md:text-sm mb-4 md:mb-3 lg:mb-4">
    ...
    <button
      onClick={() => handleViewResults(quiz)}
      className="w-full sm:w-full md:w-[85%] lg:w-[75%] xl:w-[65%] mx-auto mt-2 md:mt-3 lg:mt-4 bg-[#5b59bb] text-white font-medium py-2 md:py-2.5 rounded-lg transition-all duration-300 flex items-center justify-center gap-2 group-hover:shadow-lg group-hover:shadow-[#5b59bb]/20 active:scale-95 text-xs sm:text-sm md:text-base"
    >
  ...
  const TabButton = ({ tab, label, isActive }) => {
    ...
    return (
      <button
  onClick={() => setActiveTab(tab)}
  className={`flex items-center justify-center gap-2 px-3 md:px-4 py-1.5 md:py-2 rounded-xl font-semibold transition-all duration-300 transform shadow-md text-xs md:text-sm lg:text-base ${isActive
      ? 'bg-[#5958bb] text-white shadow-lg scale-105 border-2 border-[#5958bb]'
      : 'bg-white text-gray-700 hover:bg-gray-50 hover:scale-102 border-2 border-gray-300 hover:border-[#5958bb]'
    }`}
>
  <FontAwesomeIcon
    icon={icon}
    className={`${isActive ? 'text-white' : 'text-gray-600'} text-xs md:text-sm lg:text-base`}
  />
  {label}
</button>
    );
        ...
        <div className={`bg-white ${fadeIn ? 'opacity-100' : 'opacity-0'}`} style={{
          ...
          <div className="mx-auto">
            ...
            <div className="mb-8">
              ...
              {/* Tab Navigation */}
              <div className="mt-6 flex flex-wrap gap-2 md:gap-4 lg:gap-8 justify-center">
                <TabButton
                  tab="new"
                  label="New"
                  isActive={activeTab === 'new'}
